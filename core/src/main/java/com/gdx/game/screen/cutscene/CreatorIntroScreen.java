...
public class CreatorIntroScreen extends CutSceneBaseScreen {
    ...
    Action getCutsceneAction() {
        ...
        return Actions.sequence(
                ...
                Actions.run(() -> showMessage(creator, "Hello adventurer! Welcome to my game, or at least my prototype game! \n Many thanks for your interest in my project, i hope you will like it.\n Do not hesitate to contribute or suggest any idea that you might have. Help is always welcome!\n Have fun :)")),
                Actions.delay(6),
